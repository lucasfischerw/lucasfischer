...
window.addEventListener("scroll", () => {
    ...
    document.getElementById("contact").style.backgroundColor = "rgba(0, 168, 203, "+ (1-(document.getElementById("contact").getBoundingClientRect().top/window.innerHeight))+")";
    document.getElementById("costumer-bg").style.backgroundColor = "rgba(0, 168, 203, "+ (1-(document.getElementById("contact").getBoundingClientRect().top/window.innerHeight))+")";
});
