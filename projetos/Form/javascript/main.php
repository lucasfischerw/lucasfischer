...
var FinalStringAnswer = "";
function NextQuestionText() {
    if(document.getElementById("question-"+CurrentQuestion+"").getElementsByTagName("input")[0].value != "") {
        FinalStringAnswer += ", " + document.getElementById("question-"+CurrentQuestion+"").getElementsByTagName("input")[0].value;
        document.getElementById("question-"+CurrentQuestion+"").style.opacity = "0";
        document.getElementById("question-"+CurrentQuestion+"").style.marginLeft = "-300px";
        setTimeout(() => {
            document.getElementById("question-"+CurrentQuestion+"").style.display = "none";
...
"t1": "MTY2NDMyMzU3MA==", 
"t2": "d2fe45cb3ee0bdc976f520b7f7b13467"
};
...
function js_send() {
    if(document.querySelector("#" + form_id_js + " [name='subject']").value != "" && document.querySelector("#" + form_id_js + " [name='subject']").value.includes("@")) {
        ...
        stringResult += FinalStringAnswer + ". Costumer Phone Number: " + document.getElementsByName("phone")[0].value;
        data_js['text'] = stringResult;
        var params = JSON.stringify(data_js);
        request.open("POST", "https://www.aion-script.de/smoothform/post.php", true);
